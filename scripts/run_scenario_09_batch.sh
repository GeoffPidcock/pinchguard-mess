...
ARMS=(aa_feed mb_0_feed mb_1_feed mb_2_feed mb_3_feed mb_4_feed)
SCEN="scenarios/09"
SCEN_NAME="scenario_09"
DATA_DIR="${PINCHGUARD_DATA_DIR:-/datapool/analysis_data/tara/pinchguard/runs}"
PY="${PINCHGUARD_PYTHON:-.venv/bin/python}"
RUNNER="notebooks/scenario_runner/run_scenario_v3.py"
LOGDIR="local/run_logs/${SCEN_NAME}"; mkdir -p "$LOGDIR"
